...
export const PopularSlider = (props) => {
  ...
  const FaqVedios = [
    ...
    {
      url: "https://cdn.joepegs.com/collections/avalanche/0x54c800d2331e10467143911aabca092d68bf4166/logo-1695251795.jpg",
    ...
    <div class="px-4 mx-auto max-w-screen-2xl ">
...

      {
        ...
        <div className=" mt-3 overflow-hidden rounded-xl">
          ...
          <div
            id="slider"
            className="flex relative bg-white p-4 w-full overflow-scroll scroll rounded-xl  whitespace-nowrap scroll-smooth border border-[#DBDBDB]"
          >
            ...
            <div className=" bg-white mx-auto pb-4 gap-x-3  rounded-3xl  flex w-full justify-around lg:justify-between  ">
              {FaqVedios.map((ele, ind) => (
                 <div className="min-w-[21rem] p-3 ">
                    <img className="w-full h-32 object-fill rounded-2xl" src={ele.url}/>
                 </div>
                ))}
            </div>
          ...
          <div className="flex justify-center mt-8 gap-10 mb-10">
          <button
              onClick={slideLeft}
              className="mx-2  left-0 border h-12 w-12 flex items-center justify-center  rounded-full"
            >
              <svg
                width="22"
                height="21"
            ...
            <button
              onClick={slideRight}
              className="mx-2 border flex right-0 h-12 w-12  items-center justify-center  rounded-full"
            >
              <svg
                width="22"
                height="21"
