...
function CategoryList() {
  ...
  return (
    <div>
        <div className='flex justify-end px-6 mt-10 mb-10'>
        <button 
        onClick={handleOpen}
        className='bg-background p-2.5 text-white rounded-lg '>
            Add Category
        </button>
        </div>
  ...
  <div class="px-4 mx-auto max-w-screen-2xl ">
      <div class="relative overflow-hidden bg-gray-100 shadow-md text-black  sm:rounded-lg">
          <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
              ...
              <div class="flex flex-col bg-white flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
...
{open && <AddCategory open={open}  handleOpen={handleOpen}/>}
    </div>
  )
}
